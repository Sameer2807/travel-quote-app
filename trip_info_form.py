...
if st.button("Add City"):
    ...
    st.experimental_rerun()  # Refresh the page to update city list
...
# Display room configuration with remove button for each room
